...
| lsusb -tv | Display USB devices in a tree-like diagram | Đường đi dữ liệu: thiết bị -> port -> USB bus -> USB controller -> PCI bus -> CPU<br>**Lưu ý**: một USB bus có thể chưa nhiều port, tất cả thiết bị chung một bus sẽ chia sẻ chung băng thông và nguồn điện của bus đó.<br>**Class=...**: Mass Storage (ổ cứng), Human Interface Device (chuột/phím), Hub (bộ chia), ...<br>**5000M**: USB 3.0 (nhanh)<br>**480M**: USB 2.0 (trung bình) |
