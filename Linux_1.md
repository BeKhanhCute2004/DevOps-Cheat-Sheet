...
| lsblk | See information about block devices | **RM (Removable)**: nếu là 1 thì đây là thiết bị có thể tháo rời (như USB), 0 là ổ cứng cố định.\
**RO (Read-Only)**: nếu là 1, thiết bị chỉ có thể đọc (như CD-ROM). |
